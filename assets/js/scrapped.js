...
function addq() {
    ...
    for (let i = 0; i < randomquestion.choices.length; i++) {
        ...
        document.getElementById(`answer-${i}`).classList = 'list-group-item q-btn'
    }
    document.getElementById('correct').classList.toggle('d-none')
}
...
function answerCheck() {
    if (event.target.textContent === randomquestion.answer) {
        ...
        document.getElementById('incorrect').classList.toggle('d-none')
    }
}
